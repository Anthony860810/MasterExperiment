...
def _RobustSTL(input, season_len, reg1=10.0, reg2= 0.5, K=2, H=12, dn1=1., dn2=1., ds1=50., ds2=1.):
    '''
    args:
    ...
    - K: number of past season samples in seasonaility extraction K=2
    - H: number of neighborhood in seasonality extraction H=5
...
def RobustSTL(input, season_len, reg1=10.0, reg2= 0.5, K=2, H=12, dn1=1., dn2=1., ds1=50., ds2=1.):
    if np.ndim(input) < 2:
